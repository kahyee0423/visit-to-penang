    ...
    <div className="font-sans">
          ...
          <div className="md:col-span-2 flex flex-col">
            ...
            <div className="md:col-span-1 md:text-left mt-8 md:mt-0">
              ...
              <div className="flex justify-end mt-10 pr-9">
                <img className="h-20" src="./TouristSpots/flutter-icon.png" alt="bluebird icon" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-12">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          {/* Icon */}
          <div className="md:col-span-3 flex justify-end relative ml-7" style={{ top: "-180px" }}>
            <img className="h-52" src="./TouristSpots/flutter-icon.png" alt="bluebird icon" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 -mt-20">
        ...
        <div className="container mx-auto flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="absolute bottom-0 left-10 flex-col text-xs" style={{ top: "400px" }}>
              <div className="flex items-center mb-1">
                <img src="./TouristSpots/map-icon.png" className="w-3 h-3 mr-1" alt="map icon" />
                <p className="text-gray-600">Georgetown, 10300 George Town, Penang</p>
              </div>
              ...
              <div className="w-full flex justify-start relative">
                <img className="h-40" src="./TouristSpots/flutter-left.png" alt="bluebird icon" />
              </div>
            </div>
          </div>
