  ...
  return (
    <div className='flex justify-center pb-[130px]'>
      <div className='flex flex-col items-center gap-y-6'>
        ...
        {/* CTA Button */}
        <button type="button" class="text-white bg-accent-orange hover:bg-accent-orange-hover font-semibold rounded-lg text-md md:text-lg px-3.5 py-2.5 md:px-5 md:py-4 w-fit">
          Explore Now
        </button>

        {/* Image */}
        <div>
          <img class="h-auto max-w-sm lg:max-w-3xl md:max-w-xl sm:max-w-lg rounded-xl" src="images/mural.jpg" alt="image description"/>
        </div>
      </div>
    </div>
  )
